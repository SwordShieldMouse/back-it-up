...
from .network.base_network_manager import BaseNetwork_Manager

from .network import hydra_reversekl_network
from utils.plot_utils import plotFunction


class HydraReverseKL_Network_Manager(BaseNetwork_Manager):
    def __init__(self, config):
        super(HydraReverseKL_Network_Manager, self).__init__(config)
        ...
        # define network
        self.network = hydra_reversekl_network.HydraReverseKLNetwork(config)
...
class HydraReverseKL(BaseAgent):
    def __init__(self, config):
        network_manager = HydraReverseKL_Network_Manager(config)
        super(HydraReverseKL, self).__init__(config, network_manager)
