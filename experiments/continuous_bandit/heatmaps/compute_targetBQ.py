...
import experiments.continuous_deep_control.environments.environments as envs
from experiments.continuous_deep_control.utils.config import Config
import quadpy
...
def main():
    ...
    env_json_path = '../../continuous_deep_control/jsonfiles/environment/{}.json'.format(env_name)
    ...
    plt.plot(intgrl_actions, q_val, color='red')

    plt.savefig('{}/original_q_val.png'.format(args.save_dir))
    plt.clf()
    exit()
