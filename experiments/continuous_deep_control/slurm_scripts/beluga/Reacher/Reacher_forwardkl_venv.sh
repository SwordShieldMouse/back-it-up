...
parallel --jobs 4 "source ~/sungsu_env/bin/activate; bash experiments/continuous_deep_control/slurm_scripts/run_script_template.sh $ENV_NAME $AGENT_NAME {} ${n_gpus}" ::: $(seq ${SLURM_ARRAY_TASK_ID} ${increment} ${end_idx})
