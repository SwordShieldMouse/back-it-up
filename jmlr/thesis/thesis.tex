...
natbib=true,uniquename=false]{biblatex}
...
\title{Greedification Operators for Policy Optimization: Investigating Forward and Reverse KL Divergences} % Title can't use formulae, symbols, superscripts, subscripts, greek letters, etc. all of which should be replaced with word substitutes
\author{Alan Chan}
...
\subfile{\main/tex/theory.tex}
\subfile{\main/tex/microworlds.tex}
\subfile{\main/tex/benchmarks.tex}
